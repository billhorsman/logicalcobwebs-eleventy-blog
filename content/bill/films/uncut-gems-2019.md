...
<article class="film slug-uncut-gems-2019">
  ...
  <div class="cast-grid-cards">
    <div class="cast-card">
  <img src="../films/profiles/19292.jpg" alt="Adam Sandler" loading="lazy">
  <div class="cast-card-info">
    ...
    <div class="cast-card">
  <img src="../films/profiles/1200864.jpg" alt="LaKeith Stanfield" loading="lazy">
  <div class="cast-card-info">
    ...
    <div class="cast-card">
  <img src="../films/profiles/2371446.jpg" alt="Julia Fox" loading="lazy">
  <div class="cast-card-info">
    ...
    <div class="cast-card">
  <img src="../films/profiles/1177652.jpg" alt="Kevin Garnett" loading="lazy">
  <div class="cast-card-info">
    ...
    <div class="cast-card">
  <img src="../films/profiles/19394.jpg" alt="Idina Menzel" loading="lazy">
  <div class="cast-card-info">
    ...
    <div class="cast-card">
  <img src="../films/profiles/10866.jpg" alt="Eric Bogosian" loading="lazy">
  <div class="cast-card-info">
  ...
  <div class="cast-card-info">
    ...
    <div class="cast-card">
  <img src="../films/profiles/2410045.jpg" alt="Keith William Richards" loading="lazy">
  <div class="cast-card-info">
    ...
    <div class="cast-card">
  <img src="../films/profiles/1315479.jpg" alt="Mike Francesa" loading="lazy">
  <div class="cast-card-info">
    ...
    <div class="cast-card">
  <img src="../films/profiles/2371447.jpg" alt="Jonathan Aranbayev" loading="lazy">
  <div class="cast-card-info">
    ...
    <div class="cast-card">
  <img src="../films/profiles/2371449.jpg" alt="Noa Fisher" loading="lazy">
  <div class="cast-card-info">
    ...
    <div class="cast-card">
  <img src="../films/profiles/1549008.jpg" alt="The Weeknd" loading="lazy">
  <div class="cast-card-info">
